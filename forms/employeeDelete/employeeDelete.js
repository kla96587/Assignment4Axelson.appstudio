...
  selName.clear()
  req1 = Ajax("https://ormond.creighton.edu/courses/375/ajax-connection.php", "POST", "host=ormond.creighton.edu&user=kla96587&pass=Chichi101!!!&database=kla96587&query=SELECT name FROM customer");
  if (req1.status == 200) {
...
    req = Ajax("https://ormond.creighton.edu/courses/375/ajax-connection.php", "POST", "host=ormond.creighton.edu&user=kla96587&pass=Chichi101!!!&database=kla96587&query=" + query)
